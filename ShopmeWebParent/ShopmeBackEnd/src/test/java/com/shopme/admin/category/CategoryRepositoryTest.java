...
public class CategoryRepositoryTest {
	...
	public void testCreateSubCategory() {
		//saving the subcategory for Category id = 1;
...
//		assertThat(savedCategory.getId()).isGreaterThan(0);		
		...
		//saving the subcategory for Category id= 1 two sub-categories at once;
...
//		repo.saveAll(List.of(laptops, components));
		...
		//saving the subcategories for Category with id=2
...
//		repo.saveAll(List.of(cameras, smartphones));
		...
		//saving the subcategory for Category id= ?;
	...
	public void testFindByAlias() {
		String aliasString = "electronics";
		Category category = repo.findByAlias(aliasString);
		
		assertThat(category).isNotNull();
		assertThat(category.getAlias()).isEqualTo(aliasString);
	}
}
